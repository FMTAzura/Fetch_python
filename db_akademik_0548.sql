...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2022 pada 09.59
...
--
-- Struktur dari tabel `tbl_students_0548`
--

CREATE TABLE `tbl_students_0548` (
  `No` int(2) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0548`
--

INSERT INTO `tbl_students_0548` (`No`, `NIM`, `Nama`, `JK`, `Jurusan`, `Alamat`) VALUES
